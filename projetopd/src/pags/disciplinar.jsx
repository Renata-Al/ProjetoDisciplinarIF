    ...
    <div className="main-contai">
      <form className="form-alt">
        <div className="containerr">
          ...
          <label>
            Aluno(s) envolvidos:<input type="text" required></input>
          </label>
          <label>
          ...
          <label>
            Data do Registro:<input type="date"></input>
          </label>
          <label>
            Data da Ocorrência:<input type="date" required></input>
          </label>
          <label>
            Hora:<input type="time"></input>
          </label>
          ...
          <label>
            Há testemunhas:<input type="text"></input>
          </label>
